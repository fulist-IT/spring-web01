...
public class PreventivoConLambdaStrana {

	private static final Logger log = LogManager.getLogger(PreventivoConLambdaStrana.class);
	...
	public PreventivoConLambdaStrana() {
		super();
...
//-> (infoSiepi.stream()
	...
	private void somma() {
		//AGGIUNGERE LA LAMBDA "blabla::blabla"
	}
